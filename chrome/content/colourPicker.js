...
function changeHex() {
  ...
  if(hex.length < 6) {
    var alstrings = document.getElementById("mdbstrings");
    //prompts.alert(null,"Modern Download Manager",alstrings.getString("colpickeralert1"));
    return;
  }
...
function ValidateData() {
  ...
  if(!gColor) {
    var alstrings = document.getElementById("mdbstrings");
    prompts.alert(null,"Modern Download Manager",alstrings.getString("colpickeralert"));
...
function useDefault() {
  ...
  document.getElementById("hexColour").value = "null";
  document.getElementById("nameColour").value = "";

  document.getElementById("swatch").style.color = "";
...
function IncreaseTextboxValue(id, maxValue) {
  ...
  if(e) {
    ...
    if(newValue != e.value) redrawEverythingAfterTexboxValueChanged(id);
    e.value = newValue;
  }
}
...
function redrawEverythingAfterTexboxValueChanged(id) {
  if(id == "hue" || id == "saturation" || id == "brightness") {
